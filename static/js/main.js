...
// Auto-set active navigation link based on current page
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (currentPath === '/' || currentPath === '/index.html') {
        ...
        activeLink = document.querySelector('.navbar-nav .nav-link[href="/"]') || 
                    document.querySelector('.navbar-nav .nav-link[href="/index.html"]');
    } else if (currentPath.startsWith('/about')) {
        activeLink = document.querySelector('.navbar-nav .nav-link[href="/about"]');
    } else if (currentPath.startsWith('/services')) {
        activeLink = document.querySelector('.navbar-nav .nav-link[href="/services"]');
    } else if (currentPath.startsWith('/service-area')) {
        activeLink = document.querySelector('.navbar-nav .nav-link[href="/service-area"]');
    } else if (currentPath.startsWith('/contact')) {
        activeLink = document.querySelector('.navbar-nav .nav-link[href="/contact"]');
    } else if (currentPath.startsWith('/blog')) {
        // For blog pages, highlight Home as active
        activeLink = document.querySelector('.navbar-nav .nav-link[href="/"]') || 
                    document.querySelector('.navbar-nav .nav-link[href="/index.html"]');
    }
